-- ============================================================
-- FitWithRam — Online/Offline Training Features Migration
...
-- 5. Member can read/insert their own inquiries
...
-- 6. Admin can do everything on inquiries
CREATE POLICY "Admin full access to inquiries"
  ON public.inquiries FOR ALL
  USING (public.is_admin())
  WITH CHECK (public.is_admin());

-- 7. Admin can update profiles (for assigned_program_id)
